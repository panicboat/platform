# root.hcl - Root Terragrunt configuration for GitHub Repository Management
...
locals {
  ...
  common_tags = {
    ...
    Repository  = "monorepo"
    Component   = "github-repository-management"
    Team        = "panicboat"
  }
}
...
remote_state {
  ...
  config = {
    ...
    # Environment-specific path: github-repository/<environment>/terraform.tfstate
