...
data "aws_iam_policy_document" "s3_access" {
  # Bucket-level operations (ListBucket は env path に絞れない、bucket 全体に許可)
  statement {
  ...
  # Object-level operations (env path 限定)
  statement {
    actions = [
      "s3:GetObject",
      "s3:PutObject",
    ...
    resources = ["arn:aws:s3:::${local.bucket_name}/${var.environment}/*"]
  }
}
```
