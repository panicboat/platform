...
- `reusable--kubernetes-builder.yaml` を新規作成し、hydrate + diff を実行する。
...
| 新規 | `.github/workflows/reusable--kubernetes-builder.yaml` | hydrate + diff の実行 |
...
act workflow_call -W .github/workflows/reusable--kubernetes-builder.yaml \
