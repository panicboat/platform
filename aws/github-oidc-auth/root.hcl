# root.hcl - Root Terragrunt configuration for GitHub OIDC Auth
...
remote_state {
  ...
  config = {
    ...
    # Service-specific path: github-oidc-auth/<environment>/terraform.tfstate
    key    = "platform/github-oidc-auth/${local.environment}/terraform.tfstate"
