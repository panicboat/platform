# root.hcl - Root Terragrunt configuration for ALB
...
remote_state {
  ...
  config = {
    ...
    # Service-specific path: alb/<environment>/terraform.tfstate
    key    = "platform/alb/${local.environment}/terraform.tfstate"
